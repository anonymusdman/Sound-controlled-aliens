function startClassifying(){
    ...
    classifier = ml5.soundClassifier("https://teachablemachine.withgoogle.com/models/1E8gqnADM/model.json", modelReady);
}  
function modelReady(){
...
function gotResults(error, results){
    if(error){
        ...
        else if(results[0].label == "Banging on pillow"){
            alien1.src = "aliens-01.png";
            alien2.src = "aliens-02.gif";
            alien3.src = "aliens-03.png";
            alien4.src = "aliens-04.png";
        }
        else if(results[0].label == "Slapping myself"){
            alien1.src = "aliens-01.png";
            alien2.src = "aliens-02.png";
